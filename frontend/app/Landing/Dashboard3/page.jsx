      ...
      <div style={styles.container}>
        <div style={styles.leftContainer}>
          ...
          <p style={styles.benefitDescription}>
            ...
            ensuring trusted skincare tailored to your needs, with the
            convenience of expert-selected solutions.
          </p>
        </div>
...
const styles = {
  ...
  imagePlaceholder: {
    width: "100%",
    height: "500px",
    backgroundImage: "url('/assets/skincare htm/3.jpg')", // Path to your image
