...
//         ); // Set major skin type
//         setSkinTypes([
//           { name: "Oily", percentage: 75 },
//           { name: "Normal", percentage: 18 },
//           { name: "Dry", percentage: 7 },
//         ]);
//         setSkinDiseases([
//           {name: "Acne", severity: "Moderate" },
//           {name: "Hyper Pigmentation", severity: "Severe" },
//           {name: "Redness", severity: "Mild" },
//         ]) // Set skin types array with percentages
...
//               <h4 style={{ color: "#BFD16D", fontSize: "22px" }}>Skin Diseases</h4>
